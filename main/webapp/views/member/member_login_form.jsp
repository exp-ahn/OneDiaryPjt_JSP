...
<script src="./js/member/member_login_form.js" type="text/javascript"></script>
	...
	<section>
		...
		<div id="section_wrap">
			...
			<div class="article">
				...
				<form action="<%=request.getContextPath()%>/member_login_confirm.mem" method="post" name="member_login_form">
					
					<input type="text" name="m_id" placeholder="INPUT MEMBER ID.">
					<br>
					<input type="password" name="m_pw" placeholder="INPUT MEMBER PW.">
					<br>
					<input type="button" value="로그인" onclick="memberLoginForm();">
